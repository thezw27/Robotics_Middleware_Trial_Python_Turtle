...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\python_turtle\hook\pythonpath.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\python_turtle\hook\ament_prefix_path.bat"
