...
class Init_SetPose_Request_set_pose
{
public:
  Init_SetPose_Request_set_pose()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  ::turtle_interfaces::srv::SetPose_Request set_pose(::turtle_interfaces::srv::SetPose_Request::_set_pose_type arg)
  {
...
{
  return turtle_interfaces::srv::builder::Init_SetPose_Request_set_pose();
}
